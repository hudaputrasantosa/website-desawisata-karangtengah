...
<head>
   ...
   <title>Tambah Produk Desa</title>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="white-box">
                     ...
                     <form class="form-horizontal form-material" action="tambah-produk-aksi" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="nama" class="form form-control" placeholder="Nama Produk">
                           </div>
                        </div>

                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="harga" class="form form-control" placeholder="Harga Produks">
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="ukuran" class="form form-control" placeholder="Ukuran Produk">
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="alamat" class="form form-control" placeholder="Alamat">
                           </div>
                        </div>

                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="whatsapp" class="form form-control" placeholder="No Whatsapp">
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           <div class="col-sm-12">
                              <input name="submit" type="submit" class="btn btn-primary" value="Posting Produk">
                           </div>
                        </div>
                     </form>
