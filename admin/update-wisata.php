               ...
               <div class="col-md-12">
                  <div class="white-box">
                     ...
                     while ($row = mysqli_fetch_array($getData)) { ?>
                        ...
                        <form class="form-horizontal form-material" action="update-wisata-aksi" enctype="multipart/form-data" method="post">
                           ...
                           <div class="form-group">
                              <div class="col-md-12">
                                 ...
                                 <input type=" text" name="nama" class="form form-control" placeholder="Nama Wisata" value="<?= $row['nama_wisata']; ?>">
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              <div class="col-md-12">
                                 <input type="text" name="lokasi" class="form form-control" placeholder="Lokasi Wisata" value="<?= $row['lokasi_wisata']; ?>">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                                 <input type="text" name="gmap" class="form form-control" placeholder="Link Embed Google Maps" value="<?= $row['gmap']; ?>">
                           ...
                           <div class="form-group">
                              <div class="col-sm-12">
                                 <input name="submit" type="submit" class="btn btn-primary" value="Update Wisata">
                              </div>
                           </div>
                        </form>
                     <?php } ?>
