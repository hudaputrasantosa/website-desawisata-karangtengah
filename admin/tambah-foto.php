            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="white-box">
                     ...
                     <form class="form-horizontal form-material" action="tambah-foto-aksi" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="nama" class="form form-control" placeholder="Nama Pengurus">
                           </div>
                        </div>

                        <div class="form-group">
                           <div class="col-md-12">
                              <input type="text" name="jabatan" class="form form-control" placeholder="Jabatan Pengurus">
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           <div class="col-sm-12">
                              <input name="submit" type="submit" class="btn btn-primary" value="Posting Foto">
                           </div>
                        </div>
                     </form>
